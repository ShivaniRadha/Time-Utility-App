...
12/24-hour format based on system time
Auto-updates every second
### **⏱️ Stopwatch**
Start, Stop, and Reset functionality
Accurate millisecond timing
Clean and easy-to-read display
### **⏲️ Countdown Timer**
Set any time duration
Start, Pause, and Reset options
Alert when time is up
**Live Demo:** 
👉 https://shivaniradha.github.io/Time-Utility-App/
## **🛠️ Technologies Used**
HTML – Structure  
CSS – Styling & Layout  
...
2. Choose between Digital Clock, Stopwatch, or Timer
3. Use the controls (Start / Stop / Reset) as needed
## **📦 Installation (Optional – Local Use)**
